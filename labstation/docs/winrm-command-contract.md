...
- Use a dedicated local administrator, e.g., `LABSTATION\LabGatewaySvc`, whose password is generated by `LabStation.exe winrm configure` and stored in the Lab Gateway secret store.
